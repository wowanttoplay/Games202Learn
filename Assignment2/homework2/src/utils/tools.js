...
function computeSquareMatrix_3by3(rotationMatrix){ // 计算方阵SA(-1) 3*3 
	...
	// 2、{P(ni)} - A  A_inverse
	let n1_sh = SHEval3(n1[0], n1[1], n1[2]);
	let n2_sh = SHEval3(n2[0], n2[1], n2[2]);
	let n3_sh = SHEval3(n3[0], n3[1], n3[2]);
	...
	// 4、R(ni) SH投影 - S
	let n1_r_sh = SHEval3(n1_r[0], n1_r[1], n1_r[2]);
	let n2_r_sh = SHEval3(n2_r[0], n2_r[1], n2_r[2]);
	let n3_r_sh = SHEval3(n3_r[0], n3_r[1], n3_r[2]);
